...
def buildObserver(updateFunction: Callable[[T], Awaitable[None]], updateIntervalSec: Optional[int] = 1) -> Callable[[Callable[[T], Awaitable[None]]], Awaitable[None]]:
    ...
    async def observer(callback):
        ...
        while (True):
            ...
            await asyncio.sleep(updateIntervalSec)
